...
if(ID==''||password=='')
{
alert("Ju lutem mbushni fushat me te dhena ! ");
if(ID=='')
$("#disp").html("<span style='color:red;'>Enter ID</span>");
if(password=='')
$("#disp2").html("<span style='color:red;'>Enter Password</span>");
...
if(result==0){
alert("I pasakte ID ose fjalekalimi ! ");
}
else{
  if(type=='Teacher')
...
<body>
  ...
  <div class="logo">Profesori dhe Studenti</div>

   <div class="midLogin" align="center">
    <form id="myForm" action="" method="post">
      <fieldset >
      <legend>Kycu</legend><center>
        ID:<br><input type="text" name="id" id="ID" placeholder="Enter your ID" size = "25" > 
          <div id="disp"></div><br>
        Fjalekalimi:<br><input type="password" name="password" id="Password" placeholder="Enter your Password" maxlength="10" size = "25"><div id="disp2"></div><br><br>

        <input type="radio" name="type" value="Teacher"> Profesori
        <input type="radio" name="type" value="Student" checked> Studenti
        <br><br>
        <span class="text-danger"></span>
        <button class="button" type="Login" id="submit" name="login" target="_blank">Kycu</button>
        <br><br>
        Nuk je regjistruar ? <a style="color:black;" href="RegistrationPage.php" >Regjistrohu</a>
      </center>
      </fieldset>
    </form>
  </div>

  <footer>Powered by the best FIEK students</footer>
</body>
</html>
