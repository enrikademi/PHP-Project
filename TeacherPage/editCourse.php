...
{	
	...
	if(empty($title) || empty($Book) || empty($Semester) || empty($description)) {
		...
		if(empty($title)) {
			echo "<font color='red'>Titulli fusha eshte e zbraste.</font><br/>";
		}
		
		if(empty($Semester)) {
			echo "<font color='red'>Sasia fusha eshte e zbraste.</font><br/>";
		}
		
		if(empty($Book)) {
			echo "<font color='red'>Libri fusha eshte e zbrast.</font><br/>";
		}
...
<body>
	...
	<form name="form1" method="post" action="editCourse.php">
		<table border="0">
			<tr> 
				<td>Titulli i kursit</td>
				<td><input type="text" name="title" value="<?php echo $title;?>"></td>
			</tr>
			<tr> 
				<td>Libri i kursit</td>
