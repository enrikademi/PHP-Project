...
var name = $('#title').val();
if(name=="")
$("#emptyTitle").html("<span style='color:red;'>Shtyp titullin</span>");
else
$("#emptyTitle").html("");
});
$("#des").blur(function() {
if(!$.trim($("#des").val()))
$("#emptyDes").html("<span style='color:red;'>Shtyp pershkrimin: </span>");
else
$("#emptyDes").html("");
});
$("#date").blur(function() {
var name = $('#date').val();
if(name=="")
$("#emptyDate").html("<span style='color:red;'>Zgjedhe nje deadline: </span>");
else
$("#emptyDate").html("");
});
...
alert("Ju lutem mbushini fushat !");
}
else
{
    ...
    $.ajax({
           ...
           processData: false,  
  			...
  			success: function(result){
				alert("Detyra u shtua me suskes <3");    
...
<br>
<label>
<span style="white-space: pre">Kursi:   </span>
...
<br>
<label>
<span style="white-space: pre">Titulli:</span>
...
<br>
   ...
   <label style="white-space: pre">Pershkrimi: 
...
<br>
   ...
   <span style="white-space: pre">Deadline: </span> 
